...
function ImageComponent({value ,value2}) {
    return (
      <div>
        ...
        <div style={{flexDirection:'row',position:'absolute',zIndex:2,left:'38em',top:'12em'}}>
           <p style={{color:'orange', fontSize:'3em'}}>Rooms and Suits</p>
           <p style={{color:'orange',fontSize:"2em",paddingLeft:'2.8em'}}>Hotels</p>
        </div>
        <div style={{backgroundColor:'white',display:'flex',justifyContent:'space-evenly',width:'14em',height:'3em',position:'absolute',right:'2em',top:'24.6em',alignItems:'center'}}>
            <p>Home</p>
