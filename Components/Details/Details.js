...
function Detail() {
  return (
    ...
    <div className={styles.DetailsPageBar} style={{backgroundColor:'orange',width:'6em',zIndex:4,borderRadius:"20px",textAlign:'center',position:'absolute',left:'15em',top:'64em'}}>
